...
%
% One line was added for ABM by Dave J, 8/24/09 (labeled 'DJ')
% Some fprintf lines were added for debugging, 9/3/09.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (obj.triggersExecuted == 0)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [D fs fsref eegchan] = readINI_DaveJ; % ADDED 8/24/09 BY DJ TO ACCOMODATE ABM SYSTEM
