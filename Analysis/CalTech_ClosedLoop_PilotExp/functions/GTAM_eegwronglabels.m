...
function F=GTAM_eegwronglabels(labeled_ind,A,W,IS,options)
...
%%%                           your own graph
%%% Input:
%%%       --- label_ind:       Index of EEG labels
%%%       --- A                graph gradient matrix (Equation 9 in ICML 08 paper);
%%%       --- W                weight matrix; 
%%%       --- IS               propagation matrix              
%%%       --- options          how many iterations for label self tuning?;
